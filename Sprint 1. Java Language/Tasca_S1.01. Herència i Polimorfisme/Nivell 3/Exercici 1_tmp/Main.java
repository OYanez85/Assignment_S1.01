...
public class Main {
    ...
    // Add a news item to a specific editor
    private static void addNewsToEditor() {
        ...
        for (Editor editor : editors) {
            if (editor.getName().equals(name)) {
                ...
                switch (type) {
                    case 1 -> {
                        // Football news (using String inputs)
    ...
    // Remove a news item from a specific editor
    ...
    // Show all news items for a specific editor
    ...
    // Calculate the total news score for a specific editor
    private static void calculateNewsScore() {
        ...
        for (Editor editor : editors) {
            if (editor.getName().equals(name)) {
                int totalScore = 0;
                for (News news : editor.getNewsList()) {
                    totalScore += news.calculateScore();  // Assuming News has calculateScore() method
                }
    ...
    // Calculate the total news price for a specific editor
    private static void calculateNewsPrice() {
        ...
        for (Editor editor : editors) {
            if (editor.getName().equals(name)) {
                double totalPrice = 0;
                for (News news : editor.getNewsList()) {
                    totalPrice += news.calculatePrice();  // Assuming News has calculatePrice() method
                }
